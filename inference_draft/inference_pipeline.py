...
G2P_PATH = "to_g2p.txt"
G2P_MODEL_PATH = "english_g2p.zip"
SAMPLING_RATE = 22050
...
PHONEMES_TO_IDS = {"<PAD>": 0, "<SIL>": 1, "IH1": 2, "T": 3, "W": 4, "AH1": 5, "Z": 6, "AH0": 7, "HH": 8, "AY1": 9, "AE1": 10, "M": 11, "JH": 12, "IH0": 13, "S": 14, "R": 15, "NG": 16, "D": 17, "UW1": 18, "AA1": 19, "B": 20, "DH": 21, "P": 22, "AO1": 23, "EH2": 24, "L": 25, "OW2": 26, "EH1": 27, "SH": 28, "ER0": 29, "N": 30, "EY1": 31, "IY0": 32, "Y": 33, "UH1": 34, "K": 35, "CH": 36, "OY1": 37, "V": 38, "IY1": 39, "OW1": 40, "F": 41, "AW1": 42, "IH2": 43, "OW0": 44, "TH": 45, "IY2": 46, "G": 47, "ER1": 48, "AW2": 49, "AY2": 50, "EH0": 51, "UW0": 52, "EY2": 53, "AA2": 54, "AA0": 55, "UW2": 56, "ZH": 57, "AY0": 58, "AE2": 59, "AE0": 60, "EY0": 61, "AH2": 62, "AO0": 63, "AW0": 64, "AO2": 65, "UH2": 66, "UH0": 67, "ER2": 68, "OY2": 69, "OY0": 70}
...
def text_to_file(user_query: str):
    ...
    subprocess.call(["mfa", "g2p", G2P_MODEL_PATH, text_path.absolute(), G2P_PATH])
    text_path.unlink()


def parse_g2p(g2p_path: str = G2P_PATH) -> List:
    with open(g2p_path, 'r') as fin:
        phonemes_ids = []
        for line in fin:
            _, word_to_phones = line.rstrip().split('\t', 1)
            phonemes_ids.extend([PHONEMES_TO_IDS[ph] for ph in word_to_phones.split(" ")])
    return phonemes_ids
