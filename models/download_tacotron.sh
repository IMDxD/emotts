...
unzip -qq models/tacotron/zipped.zip tacotron_vctk_default/feature_model.pth tacotron_vctk_default/phonemes.json tacotron_vctk_default/speakers.json -d models/tacotron
mv mv models/tacotron/tacotron_vctk_default/* models/tacotron
