...
class SupportedEmotions:
    angry: Emotion = Emotion(
        name="angry",
        api_name="angry",
        reference_mels_path="models/ru/emo_reference/mels/angry.pkl",
        ru_speaker_id=10,
        en_speaker_id=0,
    )
    happy: Emotion = Emotion(
        name="happy",
        api_name="happy",
        reference_mels_path="models/ru/emo_reference/mels/happy.pkl",
        ru_speaker_id=21,
        en_speaker_id=0,
    )
    sad: Emotion = Emotion(
        name="sad",
        api_name="sad",
        reference_mels_path="models/ru/emo_reference/mels/sad.pkl",
        ru_speaker_id=40,
        en_speaker_id=0,
    )
    very_angry: Emotion = Emotion(
        name="very_angry",
        api_name="veryangry",
        reference_mels_path="models/ru/emo_reference/mels/very_angry.pkl",
        ru_speaker_id=41,
        en_speaker_id=0,
    )
    very_happy: Emotion = Emotion(
        name="very_happy",
        api_name="veryhappy",
        reference_mels_path="models/ru/emo_reference/mels/very_happy.pkl",
        ru_speaker_id=12,
        en_speaker_id=0,
    )
