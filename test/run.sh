...
python src/preprocessing/01_preprocessing.py --input-dir $OUTPUT_DIR/raw/audio --output-dir $OUTPUT_DIR/processed/audio_single_mic --audio-ext flac

echo -e "\n2. Pausation cutting with VAD"
python src/preprocessing/02_pausation_cutting.py --input-dir $OUTPUT_DIR/processed/audio_single_mic --output-dir $OUTPUT_DIR/processed/no_pause --target-sr 48000

echo -e "\n3. Resampling"
python src/preprocessing/03_resampling.py --input-dir $OUTPUT_DIR/processed/no_pause --output-dir $OUTPUT_DIR/processed/resampled --resample-rate 22050

echo -e "\n4. Audio to Mel"
python src/preprocessing/04_wav_to_mel.py --input-dir $OUTPUT_DIR/processed/resampled --output-dir $OUTPUT_DIR/processed/mels

echo -e "\n5. Text normalization"
python src/preprocessing/05_text_normalization.py --input-dir $OUTPUT_DIR/raw/text --output-dir $OUTPUT_DIR/processed/mfa_inputs
...
echo -e "\n7. MFA Preprocessing"
python src/preprocessing/06_mfa_preprocessing.py --input-dir $OUTPUT_DIR/processed/resampled --output-dir $OUTPUT_DIR/processed/mfa_inputs
...
# python src/preprocessing/07_mfa_postprocessing.py --input-dir $OUTPUT_DIR/processed/mfa_outputs
python src/preprocessing/07_mfa_postprocessing.py --input-dir $OUTPUT_DIR/processed/mels